...
namespace PeoManageSoft.Business.Application.Department.Delete
{
    ...
    internal sealed class DeleteApplication : IDeleteApplication
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Application.Department.Delete.DeleteApplication class.
        /// </summary>
        /// <param name="removeHandler">Handles all commands to remove the department.</param>
