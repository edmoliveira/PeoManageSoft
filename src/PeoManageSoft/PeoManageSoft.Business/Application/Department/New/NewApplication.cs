...
namespace PeoManageSoft.Business.Application.Department.New
{
    ...
    internal sealed class NewApplication : INewApplication
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Application.Department.New.NewApplication class.
        /// </summary>
        /// <param name="newValidation">Application layer validation object.</param>
        /// <param name="addHandler">Handles all commands to add the department.</param>
        ...
        /// <summary>
        /// Handles the application layer of the new department and asynchronously using Task.
        /// </summary>
