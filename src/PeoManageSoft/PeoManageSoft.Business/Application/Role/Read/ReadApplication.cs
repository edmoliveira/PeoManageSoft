...
namespace PeoManageSoft.Business.Application.Role.Read
{
    ...
    internal sealed class ReadApplication : IReadApplication
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Application.Role.Read.ReadApplication class.
        /// </summary>
        /// <param name="readValidation">Application layer validation object</param>
        /// <param name="getHandler">Handles all queries to get the role.</param>
