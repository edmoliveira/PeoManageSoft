...
namespace PeoManageSoft.Business.Application.Role.ReadAll
{
    ...
    internal sealed class ReadAllApplication : IReadAllApplication
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Application.Role.ReadAll.ReadAllApplication class.
        /// </summary>
        /// <param name="getAllHandler">Handles all queries to get all the role.</param>
