...
namespace PeoManageSoft.Business.Application.Title.Change
{
    ...
    internal sealed class ChangeApplication : IChangeApplication
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Application.Title.Change.ChangeApplication class.
        /// </summary>
        /// <param name="changeValidation"> Application layer validation object.</param>
        /// <param name="updateHandler">Handles all commands to update the title.</param>
