...
namespace PeoManageSoft.Business.Application.Title.Delete
{
    ...
    internal sealed class DeleteApplication : IDeleteApplication
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Application.Title.Delete.DeleteApplication class.
        /// </summary>
        /// <param name="removeHandler">Handles all commands to remove the title.</param>
