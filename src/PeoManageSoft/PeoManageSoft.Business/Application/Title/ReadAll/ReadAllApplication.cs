...
namespace PeoManageSoft.Business.Application.Title.ReadAll
{
    ...
    internal sealed class ReadAllApplication : IReadAllApplication
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Application.Title.ReadAll.ReadAllApplication class.
        /// </summary>
        /// <param name="getAllHandler">Handles all queries to get all the title.</param>
