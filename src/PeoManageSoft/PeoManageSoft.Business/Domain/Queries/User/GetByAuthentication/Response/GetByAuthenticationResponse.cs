...
{
    /// <summary>
    /// Response for the get user by authentication query.
    /// </summary>
    internal class GetByAuthenticationResponse
    {
        #region Properties
        ...
        /// </summary>
        public GetByAuthenticationTitleResponse Title { get; set; }
        /// <summary>
        /// The object that describes user's department.
        /// </summary>
        public GetByAuthenticationDepartmentResponse Department { get; set; }
        /// <summary>
        /// User email
        /// </summary>
