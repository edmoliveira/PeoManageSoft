...
namespace PeoManageSoft.Business.Domain.Services.Queries.Department.GetAll
{
    ...
    internal sealed class GetAllHandler : IGetAllHandler
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Domain.Services.Queries.Department.GetAll.GetAllHandler class.
        /// </summary>
        /// <param name="transactionScope">Create the code block transactional.</param>
        /// <param name="query">Get all department query.</param>
        ...
        /// <summary>
        /// Handles the get all department query
        /// </summary>
        /// <param name="request">Request for the get all department query.</param>
        /// <returns>
