...
namespace PeoManageSoft.Business.Domain.Services.Queries.Role.GetAll
{
    ...
    internal sealed class GetAllHandler : IGetAllHandler
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Domain.Services.Queries.Role.GetAll.GetAllHandler class.
        /// </summary>
        /// <param name="transactionScope">Create the code block transactional.</param>
        /// <param name="query">Get all role query.</param>
        ...
        /// <summary>
        /// Handles the get all role query
        /// </summary>
        /// <param name="request">Request for the get all role query.</param>
        /// <returns>
        /// Task: Represents an asynchronous operation. 
        /// Response for the get all role query.
        /// </returns>
