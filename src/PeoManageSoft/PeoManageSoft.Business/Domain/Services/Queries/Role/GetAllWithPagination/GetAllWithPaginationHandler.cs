...
namespace PeoManageSoft.Business.Domain.Services.Queries.Role.GetAllWithPagination
{
    ...
    internal sealed class GetAllWithPaginationHandler : IGetAllWithPaginationHandler
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Domain.Services.Queries.Role.GetAllWithPagination.GetAllWithPaginationHandler class.
        /// </summary>
        /// <param name="transactionScope">Create the code block transactional.</param>
        /// <param name="query">Query to get all roles with pagination.</param>
        ...
        /// <summary>
        /// Handles the query to get all roles with pagination.
        /// </summary>
        /// <param name="request">Request for the query to get all roles with pagination..</param>
        /// <returns>
        /// Task: Represents an asynchronous operation. 
        /// Response for the query to get all roles with pagination.
        /// </returns>
