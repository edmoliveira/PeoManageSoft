...
namespace PeoManageSoft.Business.Domain.Services.Queries.Role.GetByRules
{
    ...
    internal sealed class GetByRulesQuery : IGetByRulesQuery
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Domain.Services.Queries.Role.GetByRules.GetByRulesQuery class.
        /// </summary>
        ...
        /// </returns>
        public async Task<IEnumerable<GetResponse>> ExecuteAsync(IScope scope, IRule<RoleEntityField> rule)
        {
