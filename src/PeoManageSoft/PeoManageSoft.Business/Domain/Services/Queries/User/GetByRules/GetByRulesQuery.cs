...
namespace PeoManageSoft.Business.Domain.Services.Queries.User.GetByRules
{
    ...
    internal sealed class GetByRulesQuery : IGetByRulesQuery
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PeoManageSoft.Business.Domain.Services.Queries.User.GetByRules.GetByRulesQuery class.
        /// </summary>
        ...
        /// </returns>
        public async Task<IEnumerable<GetResponse>> ExecuteAsync(IScope scope, IRule<UserEntityField> rule)
        {
